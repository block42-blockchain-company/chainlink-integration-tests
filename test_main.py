...
LINK_ADDR = "0xb3654dc3D10Ea7645f8319668E8F54d2574FBdC8"  # old: "0x6F43FF82CCA38001B6699a8AC47A2d0E66939407"
ORACLE_TEST_ADDR = "0x03dB4015969a319f3773c62838De205a984C147c"  # test/Old?: "0xEB7B1605eB5312B1c160730b900DF03fDB7C2C90"
ORACLE_ADDR = "0x234256711dB1e916c51aEcf1DF6351bcf246a24d"
CHAINLINK_NODE_ADDR = "0x3fD381B7308B614e993a4941e60809d7F83563a6"
CHAINLINK_JOBID = "39174b95f7f74d85a448927e0dcf2bf9"
MAINNET = True
...
def call_deployt_api_test():
    ...
    fantom_ctrl.send(api_test_consumer["abi"], ORACLE_TEST_ADDR, "requestEthereumPrice",
...
def balanceof():
    ...
    fantom_ctrl.call(link_contract["abi"], LINK_ADDR, "balanceOf", ORACLE_ADDR)
...
def set_fullfilment_permission():
    ...
    fantom_controller.send(oracle_contract["abi"], ORACLE_ADDR,
                           "setFulfillmentPermission", CHAINLINK_NODE_ADDR, True)
