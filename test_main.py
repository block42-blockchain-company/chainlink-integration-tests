...
ORACLE_TEST_ADDR = "0xd9d0C8Dcc8D1d2b3a87dfFC3711E8e5b608A15b4"
...
CHAINLINK_NODE_ADDR = "0x0152573aF663c3FbE8240D3f318e8D8F2857A1Ab"
...
CHAINLINK_JOBID = "e9eaf9faadbe48feaab6f29b87a55582"
OWNER_ADDR = "0x83BFb2beA0e486Ef125a71C08407f9541d3f5091"
MAINNET = False
...
def call_deployt_api_test():
    ...
    fantom_ctrl.send(api_test_consumer["abi"], fantom_ctrl.w3.toChecksumAddress(ORACLE_TEST_ADDR), "requestEthereumPrice",
                     fantom_ctrl.w3.toChecksumAddress(ORACLE_ADDR), CHAINLINK_JOBID)
...
def call_deployt_api_test_current_price():
    ...
    api_test_consumer = solidity_ctrl.getContract(
        ROOT_DIR + "/contracts/OracleConsumer/APITestConsumer.sol:APITestConsumer")
    fantom_ctrl.call(api_test_consumer["abi"], ORACLE_TEST_ADDR, "currentPrice")
...
def fund_test_api_contract():
    ...
    fantom_ctrl.send(link_contract["abi"], LINK_ADDR, "transfer", ORACLE_TEST_ADDR, 100 * (10 ** 18))
...
def balanceof():
    ...
    fantom_ctrl.call(link_contract["abi"], fantom_ctrl.w3.toChecksumAddress(LINK_ADDR), "balanceOf",
                     fantom_ctrl.w3.toChecksumAddress(ORACLE_TEST_ADDR))
    fantom_ctrl.call(link_contract["abi"], fantom_ctrl.w3.toChecksumAddress(LINK_ADDR), "balanceOf",
                     fantom_ctrl.w3.toChecksumAddress(ORACLE_ADDR))
...
def fund():
    ...
    fantom_controller.sendFtm((2 * (10 ** 18)), ORACLE_TEST_ADDR)
...
def set_fullfilment_permission():
    ...
    fantom_controller.send(oracle_contract["abi"], fantom_controller.w3.toChecksumAddress(ORACLE_ADDR),
                           "setFulfillmentPermission", fantom_controller.w3.toChecksumAddress(CHAINLINK_NODE_ADDR), True)
